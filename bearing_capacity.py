...
# Cohesion of soil
# 420 lb/ft^2 (soil type SM-saturated, UCSC Classification)
c_prime = int(input('Enter cohesion: '))
...
print('q_all:', q_all, 'kip/ft^2', sep=" ",
      file=open("Ultimate_Bearing_Capacity.txt", "a"))
